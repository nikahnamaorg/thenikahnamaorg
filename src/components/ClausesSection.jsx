  ...
  const clauses = [
    {
      ...
      content:
        ...
        "This clause also identifies exactly which Nikah Registrar and Union Council were responsible for officiating and registering your marriage. That proves your marriage is valid and officially recognised under the Muslim Family Laws Ordinance, 1961, and secures your marital status for inheritance, pension, or other legal claims later on.\n" +
    ...
    },
    {
      ...
      content:
        ...
        "Why care? Identity and address matter because they confirm who the groom is and where he belongs. This information goes on record for legal use, like passports, IDs, and even court cases.\n" +
    ...
    },
    {
      ...
      content:
        ...
        "Clause 6 highlights the bride, recording her age and journey with care. It honours her readiness, dreams, and identity, allowing her to step into marriage with dignity. It's more than a record. It recognises her life and her rights.",
      table: {
